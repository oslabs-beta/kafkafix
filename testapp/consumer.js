...
var kafkaSubscribe = function (topic) { return __awaiter(void 0, void 0, void 0, function () {
    var consumer, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, consumer.subscribe({ topic: topic })];
            case 2:
                _a.sent();
            ...
            case 4:
                e_1 = _a.sent();
                console.log('Error in consuming => ', e_1);
                return [3 /*break*/, 5];
